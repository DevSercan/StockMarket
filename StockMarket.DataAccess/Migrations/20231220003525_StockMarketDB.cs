...
{
    /// <inheritdoc />
    public partial class StockMarketDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(type: "varchar(26)", nullable: false),
                    Balance = table.Column<decimal>(type: "decimal(16,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BalanceCards_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(16,2)", nullable: false),
                    Commission = table.Column<decimal>(type: "decimal(4,3)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Balance", "Email", "FirstName", "LastName", "Password", "RoleId" },
                values: new object[,]
                {
                    { 1, 0m, "admin", "admin", "admin", "admin", 1 },
                    { 2, 0m, "vault", "vault", "vault", "vault", 3 }
                });

            migrationBuilder.CreateIndex(
                name: "IX_BalanceCards_Code",
                table: "BalanceCards",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BalanceCards_UserId",
                table: "BalanceCards",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceHistories_StockId",
